  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        {filtered.map((event) => (
          <div key={event.id}>
            {editingEvent?.id === event.id && isSuperAdmin ? (
              <form
                onSubmit={handleUpdateEvent}
                className="bg-white rounded-xl p-4 shadow-sm border-2 border-primary-300 space-y-3"
              >
              ...
              <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:border-primary-200 transition">
